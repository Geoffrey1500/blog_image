...
if __name__ == '__main__':
    ...
    mould_A = np.sqrt(center_A[0] ** 2 + center_A[1] ** 2)
    mould_B = np.sqrt(center_B[0] ** 2 + center_B[1] ** 2)
    triangular_angle = np.arccos((center_A[0] * center_B[0] + center_A[1] * center_B[1]) / (mould_A * mould_B))
    print(triangular_angle*180/np.pi)
